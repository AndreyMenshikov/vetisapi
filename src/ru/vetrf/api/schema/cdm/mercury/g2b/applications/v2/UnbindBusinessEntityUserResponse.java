 ...
 * 
 * <p>Java class for UnbindBusinessEntityUserResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="UnbindBusinessEntityUserResponse">
 *   &lt;complexContent>
...
@XmlType(name = "UnbindBusinessEntityUserResponse", propOrder = {
    "user"
})
public class UnbindBusinessEntityUserResponse
    extends ApplicationResultData
{
    ...
    /**
     * Пользователь, который был откреплен от ХС-заявителя.Gets the value of the user property.
     * 
     * <p>
