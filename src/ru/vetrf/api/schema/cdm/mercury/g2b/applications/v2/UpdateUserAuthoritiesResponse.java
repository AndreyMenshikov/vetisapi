 ...
 * 
 * <p>Java class for UpdateUserAuthoritiesResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="UpdateUserAuthoritiesResponse">
 *   &lt;complexContent>
...
@XmlType(name = "UpdateUserAuthoritiesResponse", propOrder = {
    "user"
})
public class UpdateUserAuthoritiesResponse
    extends ApplicationResultData
{
    ...
    /**
     * Пользователь, для которого были изменены права доступа.Gets the value of the user property.
     * 
     * <p>
