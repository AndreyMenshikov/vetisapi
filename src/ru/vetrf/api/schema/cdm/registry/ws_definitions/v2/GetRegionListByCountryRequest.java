 ...
 *         &lt;element ref="{http://api.vetrf.ru/schema/cdm/dictionary/v2}countryGuid"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "getRegionListByCountryRequest")
public class GetRegionListByCountryRequest {
    ...
    /**
     * Глобальный идентификатор страны, для которой
