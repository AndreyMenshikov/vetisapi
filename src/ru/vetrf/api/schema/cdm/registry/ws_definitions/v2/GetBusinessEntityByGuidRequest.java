...
@XmlRootElement(name = "getBusinessEntityByGuidRequest")
public class GetBusinessEntityByGuidRequest {

    @XmlElement(namespace = "http://api.vetrf.ru/schema/cdm/base", required = true)
    protected String guid;

    /**
     * Глобальный идентификатор, по которому проводится поиск записи.
     *                   
     * 
     * @return
     *     possible object is
